...
const LowerGround = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 380.13 316.78" className='mx-auto w-full p-2 h-[70vh] '>
  <defs>
    <style>
    {`
    .cls-1 {
  ...
  <g id="Layer_2" data-name="Layer 2">
    <g id="Layer_1-2" data-name="Layer 1">
      ...
      <circle class="cls-4 cursor-pointer" cx="40.28" cy="119.67" r="14.08" /><text class="cls-5 cursor-pointer" transform="translate(37.55 122.45)">L1</text>
      <circle class="cls-4 cursor-pointer" cx="113.8" cy="119.67" r="14.08" /><text class="cls-5 cursor-pointer" transform="translate(110.14 122.45)">L2</text>
      <circle class="cls-4 cursor-pointer" cx="186.15" cy="119.67" r="14.08" /><text class="cls-5 cursor-pointer" transform="translate(182.44 122.45)">L3</text>
      <circle class="cls-4 cursor-pointer" cx="298" cy="119.67" r="14.08" /><text class="cls-5 cursor-pointer " transform="translate(294.14 122.45)">L4</text>
      <g id="Padlock">
