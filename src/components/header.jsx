  ...
  {/* sm:justify-start mb:justify-start */}
            <div className='text-primary      flex flex-row   justify-around'>
                <div className='flex flex-row justify-center items-center space-x-5'>
                    ...
                    <AiOutlineMenu size={22}  className="mb:block sm:block hidden text-white bg-floorText  p-2 w-fit rounded-full h-fit cursor-pointer"/>
                ...
                <div className='flex flex-row items-center '>
                    ...
                    <label className='h-[51.09px] w-fit rounded-3xl border-[1px] text-center text-white  border-floorText cursor-pointer  hover:bg-floorText hover:text-white hidden sm:flex mb:flex  flex-row justify-center items-center   px-8'  htmlFor="my-modal">
                        {/* <div  > */}
                            Appartments
                        {/* </div> */}
                    </label>
